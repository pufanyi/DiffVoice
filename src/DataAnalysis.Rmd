...
corrplot(correlation_matrix, method = "color", type = "upper", order = "hclust", tl.col = "black", tl.srt = 45, addCoef.col = "black", number.cex = 0.7)
```
...
corrplot(correlation_matrix, method = "color", type = "upper", order = "hclust",
         ...
         addrect = 4, rect.col = "black", rect.lwd = 2)
```
