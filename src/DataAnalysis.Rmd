...
pdf("../report/graphs/distribution.pdf", width = 30, height = 7)
...
```{r}
pdf("../report/graphs/transformations_hist.pdf", width = 12, height = 17)
...
pdf("../report/graphs/transformations_qq.pdf", width = 20, height = 13)
