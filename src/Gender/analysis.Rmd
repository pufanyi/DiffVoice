...
```
```{r}
original_size = (dim(male_data))[1]
male_data = remove_outliers(variable, male_data)
removed_size = original_size-(dim(male_data))[1]
removed_size

original_size = (dim(female_data))[1]
female_data = remove_outliers(variable,female_data)
removed_size = original_size-(dim(female_data))[1]
removed_size
```
### QQ-plot
