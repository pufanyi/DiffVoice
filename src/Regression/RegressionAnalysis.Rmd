...
```{r}
pdf("../../report/graphs/simple_linear_regression_plot.pdf", width = 9, height = 6)
...
```{r}
pdf("../../report/graphs/multiple_lr.pdf", width = 6, height = 6)
...
pdf("../../report/graphs/heatmaps.pdf", width = 10, height = 4)
